...
const postData = (url, data) => {
    try {
        return axios.post(url, data, { validateStatus: false });
    } catch (e) {
...
const patchData = async (url, data) => {
    try {
        return await axios.patch(url, data, { validateStatus: false });
    } catch (e) {
...
const deleteData = async (url, data) => {
    try {
        return await axios.delete(url, { validateStatus: false });
    } catch (e) {
